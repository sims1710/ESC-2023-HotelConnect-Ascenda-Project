...
describe('API Test', () => {
    it('should return an HTML page', (done) => { // Use the done callback
      request(app)
        .get('/')
...
/*describe('Test Cases for Express App', function () {
  ...
  it('should respond with an error for missing query parameters', function (done) {
    supertest(app)
      .get('/api/disphotels?destination_id=fRZM&lang=en&currency=USD&checkin=2023-08-01&checkout=2023-08-05&guests=2')
      .expect(400, done);
  });
